...
class ManufacturerControllerSpringBootTest {
    ...
    //Создание категории, обновить категорию, получить категорию, удалить категорию
    ...
    public void handleUpdateTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/manufacturer/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper
                                .writeValueAsString(ManufacturerDto.builder()
                                        .manufacturerId(1L)
    ...
    public void getManufacturerTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/manufacturer/1"))
                .andExpect(status().isOk())
    ...
    public void deletedByIdTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/manufacturer/1"))
                .andExpect(status().isNoContent());
    }
